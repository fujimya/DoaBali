...
import com.example.doabali.Adapter.AdapterKidung;
...
public class KidungActivity extends AppCompatActivity {
    private ArrayList<String> urlkidung = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    urlkidung.add(child.child("url").getValue().toString());
                }
                if (urlkidung.isEmpty()) {
        ...
        rvView.setLayoutManager(new GridLayoutManager(KidungActivity.this, 1));
        adapter = new AdapterKidung(KidungActivity.this,urlkidung,title,subtitle);
